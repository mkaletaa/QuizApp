...
export const correctAnswers = 'Correct answers(s)'
export const yourAnswers = 'Your answers(s)'
...
export const noInternetMessage =
  'You don\'t have Internet connection. Some sources like images may not load properly.'
...
export const longPress =
  'long press to see the question once again'
