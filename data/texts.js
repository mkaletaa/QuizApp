...
export const takeAQuiz = 'Test yourself'
...
export const reportAMistake = 'Mistake report'
...
export const retake = 'Retake the quiz'
export const retakeWrong = 'Correct the wrong answers'
...
export const codeSettings = 'Code settings'
export const selectCodeTheme = 'Select the code theme'
